...
function updateCartTotal() {
    ...
    var downloadBtn = document.getElementById('settings');
    ...
    if(JSON.parse(localStorage.getItem('banklogs')).length == 1) {
        ...
        if(bankLog.includes('Huntington') || bankLog.includes('Woodforest') || bankLog.includes('Barclays')) {
            ...
            showToast.innerHTML = `
                Get ${bankLog.split('Bank')[0]} Info <img src="img/partners/doh.png">
            `;
        } else if(bankLog.includes('America')) {
            downFile.innerHTML = 'BankofAmerica';
            showToast.innerHTML = `
                Get BankofAmerica Info <img src="img/partners/doh.png">
            `;
        } else {
            downFile.innerHTML = bankLog.split('[')[0];
            showToast.innerHTML = `
                Get ${bankLog.split('[')[0]} Info <img src="img/partners/doh.png">
            `;
        }
        ...
        if(platform.manufacturer !== null) {
            anonP.innerHTML = `
                ...
                Bank log file will be saved on your 
        ...
        downloadBtn.innerHTML = `Download <img src=${bankImg}>`;
        anonCheck.innerHTML = `
        ...
        if(platform.manufacturer !== null) {
            anonP.innerHTML = `
                <hr class="thehr" style="margin-top: -10px;">
        ...
        `;
        downloadBtn.innerHTML = `Download <img src="img/partners/doh.png" style="height: 23px !important; width: 23px !important">`;
